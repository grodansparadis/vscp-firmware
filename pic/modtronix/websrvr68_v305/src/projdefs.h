...
#define DEBUG_OFF   //release Ensure this is not commented out!
#ifdef DEBUG_OFF
    ...
    #define DEBUG_MAC       LOG_DEBUG   /* Debug code = 0xD5 */
    #define DEBUG_MAIN      LOG_DEBUG   /* Debug code = 0xD6 */
    #define DEBUG_NBNS      LOG_DEBUG   /* Debug code = 0xDB */
    #define DEBUG_STACKTSK  LOG_INFO    /* Debug code = 0xD7 */
