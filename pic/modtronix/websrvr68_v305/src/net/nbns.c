...
/////////////////////////////////////////////////
//Debug defines
#define debugPutMsg(msgCode) debugPut2Bytes(0xDB, msgCode)
#define debugPutMsgRomStr(msgCode, strStr) debugMsgRomStr(0xDB, msgCode, msgStr)
