 ...
 *
 * @param localIP   Local node IP Address as received in current IP header.
...
/**
 * Sets the receive buffer access point to given offset in IP Data.
 ...
 *
 * @param a     Offset, An offset with respect to IP Data
 *
 */
