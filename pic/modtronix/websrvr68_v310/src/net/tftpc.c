...
/////////////////////////////////////////////////
//Debug defines
#define debugPutMsg(msgCode) debugPut2Bytes(0xDC, msgCode)
#define debugPutMsgRomStr(msgCode, strStr) debugMsgRomStr(0xDC, msgCode, msgStr)
...
#define TFTP_CLIENT_PORT        (65352ul)   // Some unique port on this
                                            // device.
#define TFTP_SERVER_PORT        (69ul)
#define TFTP_BLOCK_SIZE         (0x200ul)   // 512 bytes
#define TFTP_BLOCK_SIZE_MSB     (0x02ul)
