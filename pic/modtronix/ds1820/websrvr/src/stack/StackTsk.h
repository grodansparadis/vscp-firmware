...
#define MY_DEFAULT_IP_ADDR_BYTE2        (1)		//mx changed from 10 to 1
#define MY_DEFAULT_IP_ADDR_BYTE3        (0)		//mx changed from 5 to 0
#define MY_DEFAULT_IP_ADDR_BYTE4        (0)		//mx changed from 15 to 0

#define MY_DEFAULT_MASK_BYTE1           (0xff)
#define MY_DEFAULT_MASK_BYTE2           (0x00)	//mx changed from 0xff to 0x00
#define MY_DEFAULT_MASK_BYTE3           (0x00)	//mx changed from 0xff to 0x00
 ...
 */
#if defined(MCHP_C18)
#define MAX_SOCKETS                     (4)		//mx Microchip compiler doesn't have enough memory for change
#elif defined(HITECH_C18)
#define MAX_SOCKETS                     (10)		//mx changed from 4 to 8
#endif
 ...
 */
#if defined(MCHP_C18)
#define MAX_HTTP_CONNECTIONS            (2)	//C18 seems not to have enough memory to do this??
#elif defined(HITECH_C18)
#define MAX_HTTP_CONNECTIONS            (5)	//mx changed from 2 to 4
#endif
