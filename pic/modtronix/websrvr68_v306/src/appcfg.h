...
enum APP_CONFIG_ENUM {
    APPCFG_IP0 = 0,                 ///< Offset = 0 = 0x00<br>Our IP address. First entry is MSB byte of IP address, for example in "192.168.1.0" it will be 192.
    ...
    /**< <hr><b>USART1</b> Configuration. Baud rate will be a BAUD_XXX define */
    APPCFG_USART1_BAUD,             ///< Offset = 31 = 0x1F
    APPCFG_USART1_CFG,              ///< Offset = 32 = 0x20

    /**< <hr><b>USART2</b> Configuration. Baud rate will be a BAUD_XXX define */
    ...
    /**< <hr><b>UDP Command Responce Port</b> */
    APPCFG_CMDRESP_UDPPORT0,        ///< Offset = 93 = 0x5D
    APPCFG_CMDRESP_UDPPORT1,        ///< Offset = 94 = 0x5E

    /**< <hr><b>UDP reserved bytes</b> */
    APPCFG_CMD_RESERVED1,           ///< Offset = 95 = 0x5F
    APPCFG_CMD_RESERVED2,           ///< Offset = 96 = 0x60
    APPCFG_CMD_RESERVED3,           ///< Offset = 97 = 0x61
     ...
     */
    APPCFG_WEB_FLAGS,               ///< Offset = 115 = 0x72

    /**< <hr><b>Web Server reserved bytes</b> */
    APPCFG_WEB_RESERVED3,           ///< Offset = 112 = 0x73
...
/**
 * Second application config structure. Contains configuration for:
 * - SPI, I2C, USART, CAN, USB serial buses
 *This structure lives in the internal
 * EEPROM, starting at address 256.<br>
 * <b>!!! IMPORTANT - Only add to end the of this structure!!!</b><br>
 * This structure can NOT get larger then 256 bytes. If it does, some code will have to be
 * changed!
 */
enum APP_CONFIG2_ENUM {

    /**< Software SPI buses enabled. Bits 0 to 7 indicate which software SPI buses have
    been enabled. */
    APPCFG_SWSPI_ENABLED,           ///< Offset = 0 = 0x00

    /**< Software SPI 1 CLK pin. Bits 4-7 point to port (0=a, 1=b..), and bits 0-3 the bit */
    APPCFG_SWSPI1_CLKPIN,           ///< Offset = 1 = 0x00
    /**< Software SPI 1 SDI pin. Bits 4-7 point to port (0=a, 1=b..), and bits 0-3 the bit */
    APPCFG_SWSPI1_SDIPIN,           ///< Offset = 2 = 0x00
    /**< Software SPI 1 SDO pin. Bits 4-7 point to port (0=a, 1=b..), and bits 0-3 the bit */
    APPCFG_SWSPI1_SDOPIN,           ///< Offset = 3 = 0x00
    /**< Software SPI 1 CS pin. Bits 4-7 point to port (0=a, 1=b..), and bits 0-3 the bit */
    APPCFG_SWSPI1_CSPIN,            ///< Offset = 4 = 0x00
    /**< Software SPI 1 Rx buf. Bits 4-7 = buffer size (0=8, 1=16, .. 5=256), and bits 0-3 the buffer */
    APPCFG_SWSPI1_RXBUF,            ///< Offset = 5 = 0x00
    /**< Software SPI 1 Tx buf. Bits 4-7 = buffer size (0=8, 1=16, .. 5=256), and bits 0-3 the buffer */
    APPCFG_SWSPI1_TXBUF,            ///< Offset = 6 = 0x00
    ...
    */
    APPCFG_SWSPI1_CONF            ///< Offset = 7 = 0x00
};
