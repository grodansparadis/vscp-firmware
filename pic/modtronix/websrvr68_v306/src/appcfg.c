...
/* String used for encoding to base64 */
    ...
    static ROM BYTE* pwmCCPRL[] = {(BYTE *)(&CCPR1L), (BYTE *)(&CCPR2L)};
#endif
...
ROM BYTE eeconfigArray[] = {
    ...
    (BYTE)DEFAULT_CMDRESP_UDPPORT,      // Offset = 93
    (BYTE)(DEFAULT_CMDRESP_UDPPORT>>8), // Offset = 94
...
//Fill up remaining space so that eeconfigArraySerial starts at EEPROM address 256
ROM BYTE eeconfigArrayFill[256-sizeof(eeconfigArray)] = {0};

ROM BYTE eeconfigArraySerial[] = {
    0x11,
    0x22,
    0x33,
    0x99,
