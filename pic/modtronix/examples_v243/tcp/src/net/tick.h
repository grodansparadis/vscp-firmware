...
//Configure for a timeout period of 10ms. To get an exact timeout period of 10ms, we set out prescaler
...
/**
 * Get the current 32 bit tick value. The given tick is incremented every 100ms
 * Has 32 Bits, range of 0 - 2^32 = 11930 hours = 497 days
...
/**
 * Get the current 16 bit tick value. The given tick is incremented every 100ms
 * Has 16 Bits, range of 0 - 65535 = 65535 x 10ms = 655 seconds = 10.9 minutes
...
/**
 * Get the current 8 bit tick value. The given tick is incremented every 100ms.
 * Has 8 Bits, range of 0 - 255 = 255 x 10ms = 2.55 seconds
