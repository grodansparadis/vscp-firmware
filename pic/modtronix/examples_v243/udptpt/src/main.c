...
*       UDP example program.
*
* This program is used together with the "TCP/UDP Throughput Test" tab in the
* Netix program. It is used to test the throughput of UDP and TCP messages
* 
