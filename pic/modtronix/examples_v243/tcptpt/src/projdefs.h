...
#define DEBUG_OFF
    ...
    #define DEBUG_GEN       LOG_DEBUG   /* Debug code = 0xA0 - 0xAF */
    #define DEBUG_HTTP      LOG_WARN    /* Debug code = 0xA0 - 0xAF */
    #define DEBUG_DHCP      LOG_INFO    /* Debug code = 0xD1 */
    #define DEBUG_FTP       LOG_WARN    /* Debug code = 0xD2 */
    #define DEBUG_FSEE      LOG_WARN    /* Debug code = 0xD3 */
    ...
    #define DEBUG_UDP       LOG_WARN    /* Debug code = 0x90 - 0x9F */
    #define DEBUG_TCP       LOG_DEBUG   /* Debug code = 0x80 - 0x8F */
