...
// Documentation
/**
@defgroup mod_examples_udp4 UDP Server 4
@ingroup  mod_examples

This example is contained in "./udp/src/main_udp4.c"

This example program shows how to send and receive UDP datagrams with
the UDPGetArray() and UDPPutArray() functions. This program
acts as the server, and listens for any data entering on UDP port 54123.
If a UDP message is received, is is read and sent back to port 54124 of
