 ...
 */
#if defined(MCHP_C18)
#define MAX_HTTP_CONNECTIONS            (4)	//Changed from 2 to 8
#elif defined(HITECH_C18)
#define MAX_HTTP_CONNECTIONS            (4)	//Changed from 2 to 4
#endif
