...
#define TCP_START_TIMEOUT_VAL   ((TICK16)TICKS_PER_SECOND * (TICK16)60)
...
//#define DEBUG_OFF
    ...
    #define DEBUG_TCPUTILS  LOG_DEBUG
    #define DEBUG_TFTPC     LOG_WARN
    #define DEBUG_UDP       LOG_INFO
    #define DEBUG_UDPUTILS  LOG_DEBUG
#endif
...
#define debugPutGenDebug(msgStr) debugMsgRomStr(0xD9, 1, msgStr)
#define debugPutGenInfo(msgStr) debugMsgRomStr(0xD9, 2, msgStr)
#define debugPutGenWarn(msgStr) debugMsgRomStr(0xD9, 3, msgStr)
#define debugPutGenError(msgStr) debugMsgRomStr(0xD9, 4, msgStr)
 ...
 * - BRD_SBC44EC
 * - BRD_SBC45EC
 * - BRD_SBC65EC		For SBC65EC Hardware V2.01 or lower
 * - BRD_SBC65EC_HW210	For SBC65EC Hardware V2.10 or higher
 * - BRD_SBC68EC		For SBC68EC Hardware V2.01 or lower
 */
//#define BRD_SBC65EC	//This is defined in the MPLAB project file
