...
<title>Modtronix SBC65EC Webpage Example</title>
</head>
...
To test the following examples, configure the relevant port as an output or input on the
 <a href="iocfg.cgi">Port Settings<a> page and set it's value on the
...
<h4>3. The following example can be used to monitor OR toggle the value of port pin B4.</h4>
 ...
 Port B4 =<br>
 %%b24&lt;input class="pinbtn" type="submit" value="%%b04" name="B4"&gt;%%b2C %%b34 %%b04 %%b3C<br>
 &lt;/form&gt;
 </pre>
...
<form method=GET action=../EXP1.CGI>
 Port B4 =
 %b24<input class="pinbtn" type="submit" value="%b04" name="B4">%b2C %b34 %b04 %b3C
</form>
