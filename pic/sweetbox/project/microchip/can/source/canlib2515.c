 ...
 *
 *
 * $Id: canlib2515.c 208 2008-11-13 23:10:01Z akhe $
 *
 ********************************************************************/

#include <plib.h>
#include <CAN\canlib2515.h>
#include <CAN\REGS2515.h>
...
PRIVATE void CAN2515ByteWrite(int Channel, unsigned char addr, unsigned char value );
PRIVATE UINT8 XferSPI( int Channel, UINT8 dat );
