...
//TODO: (DF) had to remove these functions based on C18 requirements for non-inline usage
    #if !defined(__18CXX)
        extern inline int32_t __attribute__ ((always_inline)) _arrayToDword(uint8_t *array)
        {
            WORD_VAL   data;
        ...
        extern inline void __attribute__ ((always_inline)) _dwordToArray(int32_t data, uint8_t *array)
        {
            DWORD_VAL   temp;
