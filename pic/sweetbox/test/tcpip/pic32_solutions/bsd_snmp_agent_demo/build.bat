...
set ELF_FILE_NAME=release/bsd_snmp_agent_demo.elf

REM List of source files that make up this project
REM note the use of batch file line-continuation character
set SOURCE=source/main.c source/snmpex.c  ^
	../Microchip/bsd_tcp_ip/source/block_mgr.c ../Microchip/bsd_tcp_ip/source/earp.c ^
	../Microchip/bsd_tcp_ip/source/eicmp.c ../Microchip/bsd_tcp_ip/source/eip.c ^
	../Microchip/bsd_tcp_ip/source/enc28j60.c ../Microchip/bsd_tcp_ip/source/etcp.c ^
	../Microchip/bsd_tcp_ip/source/ether.c ../Microchip/bsd_tcp_ip/source/eudp.c ^
	../Microchip/bsd_tcp_ip/source/gpfunc.c ../Microchip/bsd_tcp_ip/source/pkt_queue.c ^
	../Microchip/bsd_tcp_ip/source/route.c ../Microchip/bsd_tcp_ip/source/socket.c ^
	../Microchip/bsd_tcp_ip/source/stackmgr.c ../Microchip/bsd_tcp_ip/source/tick.c ^
	../Microchip/bsd_snmp_agent/source/snmp.c ^
	../Microchip/fat16/source/fat.c ../Microchip/fat16/source/fileio.c ^
	../Microchip/fat16/source/mediasd.c ../Microchip/Common/ex16lcd.c ^
	../Microchip/Common/mstimer.c ../Microchip/bsd_dhcp_client/dhcp.c
