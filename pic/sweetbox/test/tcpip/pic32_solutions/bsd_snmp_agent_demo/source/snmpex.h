...
#ifndef _WINDOWS
#define mSetupLed5()            mPORTASetPinsDigitalOut(BIT_2)
#define mGetLed5()              (mPORTAReadLatchBits(BIT_2) == BIT_2)
#define mSetLed5()              mPORTASetBits(BIT_2)
#define mClearLed5()            mPORTAClearBits(BIT_2)

#define mSetupLed6()            mPORTASetPinsDigitalOut(BIT_3)
#define mGetLed6()              (mPORTAReadLatchBits(BIT_3) == BIT_3)
#define mSetLed6()              mPORTASetBits(BIT_3)
#define mClearLed6()            mPORTAClearBits(BIT_3)

#define mSetupSwitch3()         mPORTDSetPinsDigitalIn(BIT_6)
#define mGetSwitch3()           (mPORTDReadBits(BIT_6) == BIT_6)
#endif
