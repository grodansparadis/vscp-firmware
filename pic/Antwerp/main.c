 ...
 * ******************************************************************************
 *
 * This software is part of the VSCP node 'Antwerp'
...
#endif
#if defined(__18F2480) || defined(__18F2580) || defined(__18F248) || defined(__18F258)
...
const const uint8_t vscp_deviceURL[] = "192.168.1.250:8080/Antwerp1.xml";
...
void init()
{
	...
	OpenTimer2( TIMER_INT_ON & 
					T2_PS_1_4 & 
					T2_POST_1_16 );
        INTCONbits.GIEH = 0;        //needed if using Timer2
        INTCONbits.GIEL = 1;        //needed if using Timer2
        RCONbits.IPEN = 1;            //enable prioritized interrupts
        IPR1bits.TMR2IP = 0;         //assign high priority to TMR2 interrupt
