...
// HM: Modified, not used any more. We use DelayMs instead.
...
//#define WAIT_FOR_IOCHRDY() {for (iochrdyCnt = 0x50; iochrdyCnt > 0; iochrdyCnt--) {if (NIC_IOCHRDY) iochrdyCnt=0; }}      //Wait for IOCHRDY pin to go high
//#define WAIT_FOR_IOCHRDY() {NOP(); while(NIC_IOCHRDY == 0);}      //Wait for IOCHRDY pin to go high
//#define WAIT_FOR_IOCHRDY() {Nop(); Nop(); Nop();}
//#  define WAIT_FOR_IOCHRDY() {Nop(); Nop();} // Delay for 200 ns on 40 MHz, 400 ns on 20 MHz PIC
//#  define WAIT_FOR_IOCHRDY() {Nop();} // Delay for 100 us on 40 MHz, 200 us on 20 MHz PIC
#  define WAIT_FOR_IOCHRDY()



/////////////////////////////////////////////////
//STACK_USE_STD_NIC defined begins here
/////////////////////////////////////////////////

#if defined(STACK_USE_STD_NIC)
...
#else
/////////////////////////////////////////////////
//STACK_USE_STD_NIC *NOT* defined begins here
/////////////////////////////////////////////////
        ...
        { \
            NIC_ADDR_IO = (a|0x20); /*Set address, set RD (RE5), clear WR (RE6) and clear reset (RE7) in same command*/ \
            NIC_DATA_IO = (b); \
            BEGIN_IO_CYCLE(); \
            WAIT_FOR_IOCHRDY(); \
            NIC_IOW_IO = 1; \
    ...
    #elif defined(BRD_SBC44EC) || defined(BRD_SBC45EC)
        #define FastNICPut(a, b) \
        { \
            WRITE_NIC_ADDR(a); \
            NIC_DATA_IO = (b); \
...
/////////////////////////////////////////////////
//STACK_USE_STD_NIC *NOT* defined end
/////////////////////////////////////////////////
