Title:		OneWire - OneWire library for fedC and wizC.
Version:	2006-02-17
...
Overview:	This library implements a complete port of the Dallas/Maxim
                "1-Wire Public Domain Kit". For documentation of the software
                contained in the library, see http://www.maxim-ic.com.

		See OWnet.htm for more information.

Installation:	At least version 12.01 of fedC or WizC is required.
