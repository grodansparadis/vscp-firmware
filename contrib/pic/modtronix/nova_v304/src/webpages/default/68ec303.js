...
function scfg(user, stackVer, appVer, bootDly, serDly, sysFlags, hasBL)
{
	...
	<table width=\"100%\" cellspacing=0 cellpadding=3> \
		...
		<tr " + (((b++%2)==1)?"":"bgcolor=\"#F0F0F0\"") + " \
			onMouseover=\"setHelp('No additional help available');\"> \
			<td class=scfgLbl>Modtronix SBC68EC Web Server Version: </td> \
			<td>&nbsp; &nbsp;"+appVer+"</td> \
			<td class=scfgLbli></td></tr> \
		<tr " + (((b++%2)==1)?"":"bgcolor=\"#F0F0F0\"") + " \
			onMouseover=\"setHelp('No additional help available');\"> \
		...
		<tr " + (((b++%2)==1)?"":"bgcolor=\"#F0F0F0\"") + " \
			...
			<td class=scfgLbli></td></tr> \
		<tr " + (((b++%2)==1)?"":"bgcolor=\"#F0F0F0\"") + " \
			onMouseover=\"setHelp('On startup, the SBC68EC will wait in bootloader mode for a while. \
		...
		<tr " + (((b++%2)==1)?"":"bgcolor=\"#F0F0F0\"") + " \
			onMouseover=\"setHelp('On startup, the SBC68EC will write a message out on its serial port and \
