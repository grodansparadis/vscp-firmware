...
//  $HeadURL: http://m2m.svn.sourceforge.net/svnroot/m2m/trunk/firmware/arm/lpc/common/LPC2148_Demo/lcd/lcd_4bit.c $
//
...
{
  lcdWriteCommand4 ((LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4) >> 4);  lcdDelayMs (30);
  lcdWriteCommand4 ((LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4) >> 4);  lcdDelayMs (30);
  lcdWriteCommand4 ((LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4) >> 4);  lcdDelayMs (30);
