//
//  $Id: monitor.c 156 2008-10-15 07:05:54Z akhe $
//  $Revision: 156 $
//  $Author: akhe $
//  $Date: 2008-10-15 09:05:54 +0200 (on, 15 okt 2008) $
//  $HeadURL: http://m2m.svn.sourceforge.net/svnroot/m2m/trunk/firmware/arm/lpc/common/LPC2148_Demo/monitor/monitor.c $
//
...
int monitorLCDStart (int argc __attribute__ ((unused)), portCHAR **argv __attribute__ ((unused)))
{
  if (taskHandles [TASKHANDLE_LCD])
    ...
    xTaskCreate (vLCDTask, (const signed portCHAR * const) "LCD", configMINIMAL_STACK_SIZE, NULL, (tskIDLE_PRIORITY + 1), &taskHandles [TASKHANDLE_LCD]);
