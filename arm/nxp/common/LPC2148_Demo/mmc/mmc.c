//
//  $Id: mmc.c 156 2008-10-15 07:05:54Z akhe $
//  $Revision: 156 $
//  $Author: akhe $
//  $Date: 2008-10-15 09:05:54 +0200 (on, 15 okt 2008) $
//  $HeadURL: http://m2m.svn.sourceforge.net/svnroot/m2m/trunk/firmware/arm/lpc/common/LPC2148_Demo/mmc/mmc.c $
//
...
static U32 mmcSendCmd (mmcSpiCmdInd_t commandIndex, U32 arg)
{
  ...
  //  Send command code
  //
  spiTransferByte (mmcCmd [commandIndex].txData);
...
static void mmcCSDImplement (void)
{
  ...
  mmcDiskStatus.writeProtect = spiHardwareWriteProtected () | CSD_GET_PERM_WRITE_PROTECT () | CSD_GET_TMP_WRITE_PROTECT ();
}
...
{
  return spiWaitReady () == 0xff;
}

BOOL mmcCardPresent (void)
{
  return spiHardwareCardPresent ();
}
