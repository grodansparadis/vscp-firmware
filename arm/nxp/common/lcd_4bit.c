//
//  $Id: lcd_4bit.c 156 2008-10-15 07:05:54Z akhe $
//  $Revision: 156 $
//  $Author: akhe $
//  $Date: 2008-10-15 09:05:54 +0200 (on, 15 okt 2008) $
//  $HeadURL: http://m2m.svn.sourceforge.net/svnroot/m2m/trunk/firmware/arm/lpc/common/lcd_4bit.c $
//
...
//  Much slower.
//
#define LCD_D4        GPIO_IO_P16
#define LCD_D5        GPIO_IO_P17
#define LCD_D6        GPIO_IO_P18
#define LCD_D7        GPIO_IO_P19
#define LCD_DATA      (LCD_D7 | LCD_D6 | LCD_D5 | LCD_D4)
#define LCD_Dx_SHIFT  ((unsigned int) 16)
#define LCD_RS        GPIO_IO_P20
#define LCD_RW        GPIO_IO_P21
#define LCD_E         GPIO_IO_P22
...
static int lcdContrastPercentage = 100;
...
{
  GPIO1_FIOCLR = (~c & 0x0f) << LCD_Dx_SHIFT;
  GPIO1_FIOSET = ( c & 0x0f) << LCD_Dx_SHIFT;
}
...
static void lcdControllerInit (void)
{
  ...
  lcdWritePort4 ((LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4) >> 4);  lcdDelayMs (30);
  lcdWritePort4 ((LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4) >> 4);  lcdDelayMs (30);
  lcdWritePort4 ((LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4) >> 4);  lcdDelayMs (30);

  lcdWriteCommand (LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4 | LCD_FUNCTION_LINES_2 | LCD_FUNCTION_FONT_5X8);  lcdDelayMs (30);
  lcdWriteCommand (LCD_COMMAND_FUNCTION | LCD_FUNCTION_BUS_4 | LCD_FUNCTION_LINES_2 | LCD_FUNCTION_FONT_5X8);  lcdDelayMs (30);
...
portTASK_FUNCTION (vLCDTask, pvParameters __attribute__ ((unused)))
{
  lcdControllerInit ();
