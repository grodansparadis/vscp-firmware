...
void init_uart(void);
U8 uart_putc_rs485(char txt_string[]);
U8 uart_putc_rs232(char txt_string[]);
char uart_getc_rs485(void);
char uart_getc_rs232(void);
...
#define UART0_LOCAL_ECHO 1 //echo of RS232 on(1)/off(0)
