...
#define UFCR_FIFO_TRIG1     (0 << 4)    // Trigger @ 1 character in FIFO
#define UFCR_FIFO_TRIG4     (1 << 4)    // Trigger @ 4 characters in FIFO
#define UFCR_FIFO_TRIG8     (2 << 4)    // Trigger @ 8 characters in FIFO
#define UFCR_FIFO_TRIG14    (3 << 4)    // Trigger @ 14 characters in FIFO
