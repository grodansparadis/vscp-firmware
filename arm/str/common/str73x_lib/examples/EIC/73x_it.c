...
{
  GPIO_BitWrite(GPIO4, GPIO_PIN_0,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_0)))); 
...
{
   GPIO_BitWrite(GPIO4, GPIO_PIN_2,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_2))));
...
{
   GPIO_BitWrite(GPIO4, GPIO_PIN_4,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_4))));
...
void TIM4_IRQHandler (void)
{
   ...
   GPIO_BitWrite(GPIO4, GPIO_PIN_8,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_8))));
...
void TIM5_IRQHandler (void)
{
   ...
   GPIO_BitWrite(GPIO4, GPIO_PIN_10,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_10))));
...
{
    GPIO_BitWrite(GPIO4, GPIO_PIN_12,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_12))));
...
{
    GPIO_BitWrite(GPIO4, GPIO_PIN_14,(BitAction)(~(GPIO_BitRead(GPIO4,GPIO_PIN_14))));
