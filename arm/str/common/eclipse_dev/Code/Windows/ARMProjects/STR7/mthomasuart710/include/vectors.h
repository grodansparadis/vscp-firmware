...
// mthomas: based on a TNKernel example:
//#define  PERIPHERAL_CLK    24000000
#define  PERIPHERAL_CLK    12000000 /* RCCU_PCLK - TODO: check */
#define  TIMER3_PRESCALER  23
#define  TIMER3_LOAD_VAL   ((PERIPHERAL_CLK / (TIMER3_PRESCALER + 1)) / 1000 - 1 )

// mthomas: callback for systick:
