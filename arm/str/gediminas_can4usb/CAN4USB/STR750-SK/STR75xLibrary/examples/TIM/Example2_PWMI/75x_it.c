...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
u16 TIM0DutyCycle = 0, TIM0Frequency = 0, TIM1ICAP1 = 1;
...
void TIM1_IC12_IRQHandler(void)
{
  ...
  TIM1ICAP1 = TIM_GetICAP1(TIM1);

  if(TIM1ICAP1 != 0)
  {
    /* Compute TIM0 frequency in Hz */
    TIM0Frequency = (30000000 / TIM1ICAP1);

    /* Compute TIM0 Duty cycle in % */
    TIM0DutyCycle = ((TIM1ICAP1 - TIM_GetICAP2(TIM1))*100 / TIM1ICAP1);
  }

  /* Clear TIM1 pending bits */
  TIM_ClearITPendingBit(TIM1, TIM_IT_IC1|TIM_IT_IC2);
}
