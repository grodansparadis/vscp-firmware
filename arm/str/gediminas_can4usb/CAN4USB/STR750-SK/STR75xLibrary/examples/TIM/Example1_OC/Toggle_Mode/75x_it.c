...
{
  /* Update TIM0_OCR2 register value */
  TIM0->OCR2 += OC2Value;
  
  /* Clear TIM0 Output Compare 2 pending bit */
...
{
  /* Update TIM0_OCR1 register value */
  TIM0->OCR1 += OC1Value;
  
  /* Clear TIM0 Output Compare 1 pending bit */
  TIM_ClearITPendingBit(TIM0, TIM_IT_OC1);
}
