...
#ifndef __CANUSBDRVH__         
#define __CANUSBDRVH__
...
// Open flags
#define CANUSB_FLAG_QUEUE_REPLACE		0x00000001	// If input queue is full remove
																								// oldest message and insert new
																								// message.
#define CANUSB_FLAG_BLOCK						0x00000002	// Block receive/transmit
#define CANUSB_FLAG_ERROR						0x00000004	// Errors will be received from the adapter.
#define CANUSB_FLAG_USE_SW					0x00000008	// Activate sliding windows protocol	
#define CANUSB_FLAG_NO_LOCAL_SEND		0x00000010	// Don't send transmited frames on
																								// other local channels for the same
																								// interface
#define CANUSB_FLAG_SILENT					0x00000020	// Just listen to CAN bus traffic
#define CANUSB_FLAG_LOOPBACK				0x00000040	// Set loopback. Can be combined with
																								// CANUSB_FLAG_SILENT for HOT loopback

// This is the vendor string - Change to your own value
#define CANUSB_DLL_VENDOR "eurosource, Sweden, http://www.eurosource.se"

#define CANUSB_MAX_CANNELS		16			// Max # of simultainus open channels
...
#define CANUSB_STATE_MSG											1			// Message is beeing read
#define CANUSB_CONTROL_RESPONSE								2			// control response is beeing read
#define CANUSB_POSTITIVE_RESPONSE							3			// Positive response
#define CANUSB_NEGATIVE_RESPONSE							4			// Positive response

// CANUSB commands
#define CANUSB_COMMAND_NOOP										0			// No operation
#define CANUSB_COMMAND_SET_BITRATE						1			// Set CAN bitrate
#define CANUSB_COMMAND_SET_FILTER							2			// Set acceptance filter
#define CANUSB_COMMAND_SET_MASK								3			// Set acceptance mask
#define CANUSB_COMMAND_OPEN										4			// Open interface
#define CANUSB_COMMAND_CLOSE									5			// Close interface
#define CANUSB_COMMAND_GET_STATUS							6			// Get status
#define CANUSB_COMMAND_GET_VERSION_FIRMWARE		7			// Get version for firmware
#define CANUSB_COMMAND_GET_VERSION_HARWARE		8			// Get version for hardware
#define CANUSB_COMMAND_GET_SERIALNO						9			// Get serial number
#define CANUSB_COMMAND_FIND_BITRATE						10		// Find bitrate
#define CANUSB_COMMAND_GET_STAT_FRAME					11		// Get statistics frame data
#define CANUSB_COMMAND_GET_STAT_DATA					12		// Get statistics data data
#define CANUSB_COMMAND_GET_STAT_ERROR					13		// Get statistics error data
#define CANUSB_COMMAND_CLR_STAT								14		// Clear statistics
#define CANUSB_COMMAND_FLUSH_TX								15		// Flush transmission queue
#define CANUSB_COMMAND_FLUSH_RX								16		// Flush receive queue
...
#define CANUSB_DLL_OBJ_MUTEX		"___CANUSB__DOS_OBJ_MUTEX____"

// protect transmit queue
#define CANUSB_DLL_TRANSMIT_MUTEX	"___CANUSB__DOS_TRANSMIT_MUTEX____"

// Receive char event
#define CANUSB_DLL_RECEIVE_CHAR_EVENT	"___CANUSB__DOS_RECEIVE_CHAR_EVENT____"

// Transmit event
#define CANUSB_DLL_TRANSMIT_FRAME_EVENT	"___CANUSB__DOS_TRANSMIT_FRAME_EVENT____"

// Transmit block
#define CANUSB_DLL_TRANSMIT_REMOVE_EVENT	"___CANUSB__DOS_TRANSMIT_REMOVE_EVENT____"
...
typedef struct {
	...
	HANDLE m_receiveFrameEvent;					// Signaled when a frame is available
...
typedef struct {
	...
	/// Channel information
	ChannelObj m_pInterfaceObjArray[ CANUSB_MAX_CANNELS ];
