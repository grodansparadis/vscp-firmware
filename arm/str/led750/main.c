...
/* GPIO Configuration --------------------------------------------------------*/
  ...
  while (1)
  {
	GPIO_WriteBit(GPIO0, GPIO_Pin_10, Bit_SET);
	Delay(0xFFFFF);
	GPIO_WriteBit(GPIO0, GPIO_Pin_10, Bit_RESET);
	Delay(0xFFFFF);
	...
	Delay(0xFFFFF);
	GPIO_WriteBit(GPIO0, GPIO_Pin_5, Bit_SET);
	Delay(0xFFFFF);
	...
	Delay(0xFFFFF);
	GPIO_WriteBit(GPIO0, GPIO_Pin_5, Bit_RESET);
	Delay(0xFFFFF);
