...
extern void             suart_config_io_(unsigned char port, unsigned char rx_pin, unsigned char tx_pin);
#endif
...
#if SREG > 0X3F
#define suart_config_io(port,rx_pin,tx_pin) suart_config_io_(port,rx_pin,tx_pin)
#elif #if SREG <= 0X3F
#define suart_config_io(port,rx_pin,tx_pin) suart_config_io_((port+0x20),rx_pin,tx_pin)
#endif

#else

#define suart_config_io(port,rx_pin,tx_pin) suart_config_io_(_SFR_MEM_ADDR(port),rx_pin,tx_pin)
