...
; Author: 	Anders Runeson, arune@user.sourceforge.net
;
...
; detected on PIND,IR
; RecievIR sets T-flag if error occured (maybe not philips remote)
;*****************************************************************************
...
;#############################################################
		...
		out		MCUCR,temp
		ldi		temp,(1<<INT0)		;Enable "External Interrupt1 Request" 
		out		GIMSK,temp
