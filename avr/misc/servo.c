...
{
	// input should be between 0 and POSITION_MAX
	u16 pos_scaled;
	// calculate scaled position
	pos_scaled = ((u16)position*(SERVO_MAX-SERVO_MIN)/POSITION_MAX)+SERVO_MIN;
	// set position
...
{
	return (u08)( ((servoGetPositionRaw(channel)-SERVO_MIN)*POSITION_MAX)/(SERVO_MAX-SERVO_MIN) );
}
