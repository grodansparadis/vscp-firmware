...
SIGNAL(ENC0_SIGNAL)
{
	...
	// check the direction line and update position accordingly
	if( inb(ENC0_PHASEB_PORTIN) & (1<<ENC0_PHASEB_PIN) )
...
SIGNAL(ENC1_SIGNAL)
{
	// encoder has generated a pulse
	// check the direction line and update position accordingly
	if( inb(ENC1_PHASEB_PORTIN) & (1<<ENC1_PHASEB_PIN) )
...
SIGNAL(ENC2_SIGNAL)
{
	// encoder has generated a pulse
	// check the direction line and update position accordingly
	if( inb(ENC2_PHASEB_PORTIN) & (1<<ENC2_PHASEB_PIN) )
...
SIGNAL(ENC3_SIGNAL)
{
	// encoder has generated a pulse
	// check the direction line and update position accordingly
	if( inb(ENC3_PHASEB_PORTIN) & (1<<ENC3_PHASEB_PIN) )
