...
;
        ...
        .global pr_writePage
        .global pr_fillTempBuffer
        .global pr_readProgramMemory
        .global pr_runApplication
        .global pr_lowFlashBank
        .global pr_highFlashBank


;
;		Note: GNU C/ASM calling convention (see e.g. "ctoasm.inc" in library sources )
;				


pr_writePage:
        RCALL   __WAIT_SPMEN__ ;Wait for SPMEN flag cleared
        MOVW    R30,R24        ;move adress to z pointer (R31=ZH R30=ZL) ( R30,R31<-R24,R25 )
        MOV     R18,R22
        RJMP	__SPMSTUFF__
