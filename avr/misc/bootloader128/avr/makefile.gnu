...
###############################################################################
	...
	MKDIR   = $(TOOL_DIR)\bin\mkdir.exe -p
	FORMAT  = srec
	MCU     = avr5
	MCUL    = atmega103

	 	
    CDEFS   = -DSYS_TARGET_GNU  -D__AVR_ATmega128__
	...
	LDFLAGS = -Wl,-Map=$(LST_DIR)\$(TRG).map,--cref -mmcu=$(MCUL) -nostartfiles \
			  -Ttext=0x01FC00 -nodefaultlibs  
