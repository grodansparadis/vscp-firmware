...
/*
#define REG_SW3_SHORT_CLASS				(PAGE1_START+40) //sw3
#define REG_SW3_SHORT_TYPE				(PAGE1_START+41)
#define REG_SW3_LONG_CLASS				(PAGE1_START+42)
#define REG_SW3_LONG_TYPE				(PAGE1_START+43)
#define REG_SW4_SHORT_CLASS				(PAGE1_START+44) //sw4
#define REG_SW4_SHORT_TYPE				(PAGE1_START+45)
#define REG_SW4_LONG_CLASS				(PAGE1_START+46)
#define REG_SW4_LONG_TYPE				(PAGE1_START+47)
#define REG_SW5_SHORT_CLASS				(PAGE1_START+48) //sw5
#define REG_SW5_SHORT_TYPE				(PAGE1_START+49)
#define REG_SW5_LONG_CLASS				(PAGE1_START+50)
#define REG_SW5_LONG_TYPE				(PAGE1_START+51)
#define REG_SW6_SHORT_CLASS				(PAGE1_START+52) //sw6
#define REG_SW6_SHORT_TYPE				(PAGE1_START+53)
#define REG_SW6_LONG_CLASS				(PAGE1_START+54)
#define REG_SW6_LONG_TYPE				(PAGE1_START+55)
#define REG_SW7_SHORT_CLASS				(PAGE1_START+56) //sw7
#define REG_SW7_SHORT_TYPE				(PAGE1_START+57)
#define REG_SW7_LONG_CLASS				(PAGE1_START+58)
#define REG_SW7_LONG_TYPE				(PAGE1_START+59)
#define REG_SW8_SHORT_CLASS				(PAGE1_START+60) //sw8
#define REG_SW8_SHORT_TYPE				(PAGE1_START+61)
#define REG_SW8_LONG_CLASS				(PAGE1_START+62)
#define REG_SW8_LONG_TYPE				(PAGE1_START+63)
*/
