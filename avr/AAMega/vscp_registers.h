...
#define REG_FIXED_TURNON1				(REG_SHUTTER_CONFIG+21)
#define REG_FIXED_TURNON2				(REG_FIXED_TURNON1+1)
#define REG_FIXED_TURNON3				(REG_FIXED_TURNON1+2)
#define REG_FIXED_TURNON4				(REG_FIXED_TURNON1+3)
#define REG_FIXED_TURNOFF1				(REG_FIXED_TURNON1+4)
#define REG_FIXED_TURNOFF2				(REG_FIXED_TURNOFF1+1)
#define REG_FIXED_TURNOFF3				(REG_FIXED_TURNOFF1+2)
#define REG_FIXED_TURNOFF4				(REG_FIXED_TURNOFF1+3)
#define REG_FIXED_TOGGLE1				(REG_FIXED_TURNOFF1+4)
#define REG_FIXED_TOGGLE2				(REG_FIXED_TOGGLE1+1)
#define REG_FIXED_TOGGLE3				(REG_FIXED_TOGGLE1+2)
#define REG_FIXED_TOGGLE4				(REG_FIXED_TOGGLE1+3)
#define REG_FIXED_LAMP1					(REG_FIXED_TOGGLE1+4)
#define REG_FIXED_LAMP2					(REG_FIXED_LAMP1+1)
#define REG_FIXED_LAMP3					(REG_FIXED_LAMP1+2)
#define REG_FIXED_LAMP4					(REG_FIXED_LAMP1+3)

#define PAGE3_END						(REG_FIXED_LAMP4+1)
