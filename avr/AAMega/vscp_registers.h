...
#define REG_OUTPUT1_SUBZONE             (PAGE1_START+16)
#define REG_SUBZONE						(REG_OUTPUT1_SUBZONE)
#define REG_OUTPUT2_SUBZONE             (PAGE1_START+17)
#define REG_OUTPUT3_SUBZONE             (PAGE1_START+18)
#define REG_OUTPUT4_SUBZONE             (PAGE1_START+19)
#define REG_OUTPUT5_SUBZONE             (PAGE1_START+20)
#define REG_OUTPUT6_SUBZONE             (PAGE1_START+21)
#define REG_OUTPUT7_SUBZONE             (PAGE1_START+22)
#define REG_OUTPUT8_SUBZONE             (PAGE1_START+23)
#define REG_OUTPUT9_SUBZONE             (PAGE1_START+24)
#define REG_OUTPUT10_SUBZONE            (PAGE1_START+25)
#define REG_OUTPUT11_SUBZONE            (PAGE1_START+26)
#define REG_OUTPUT12_SUBZONE            (PAGE1_START+27)
#define REG_OUTPUT13_SUBZONE            (PAGE1_START+28)
#define REG_OUTPUT14_SUBZONE            (PAGE1_START+29)
#define REG_OUTPUT15_SUBZONE            (PAGE1_START+30)
#define REG_OUTPUT16_SUBZONE            (PAGE1_START+31)
#define REG_OUTPUT_STATE1	            (PAGE1_START+32) //never written to, handled in readAppreg routine
#define REG_OUTPUT_STATE2	            (PAGE1_START+33) //...
#define REG_OUTPUT_DEFAULT_STATE1       (PAGE1_START+34)
#define REG_OUTPUT_DEFAULT_STATE2       (PAGE1_START+35)
#define PAGE1_END						(REG_OUTPUT_DEFAULT_STATE2)
