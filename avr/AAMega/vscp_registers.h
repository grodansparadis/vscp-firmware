...
//page3
#define NRofShutters					4
#define PAGE3_START						(PAGE2_END+1)
#define REG_SHUTTER_CONFIG				(PAGE3_START)
#define REG_SHUTTER1_ACTUAL				(1)//RAM
#define REG_SHUTTER2_ACTUAL				(2)
#define REG_SHUTTER3_ACTUAL				(3)
#define REG_SHUTTER4_ACTUAL				(4)
#define REG_SHUTTER1_WANTED				(5)
#define REG_SHUTTER2_WANTED				(6)
#define REG_SHUTTER3_WANTED				(7)
#define REG_SHUTTER4_WANTED				(8)
#define REG_SHUTTER1_MAX				(REG_SHUTTER_CONFIG+1)
#define REG_SHUTTER2_MAX				(REG_SHUTTER_CONFIG+2)
#define REG_SHUTTER3_MAX				(REG_SHUTTER_CONFIG+3)
#define REG_SHUTTER4_MAX				(REG_SHUTTER_CONFIG+4)
#define REG_SHUTTER1_PRESET1			(REG_SHUTTER_CONFIG+5)
#define REG_SHUTTER2_PRESET1			(REG_SHUTTER_CONFIG+6)
#define REG_SHUTTER3_PRESET1			(REG_SHUTTER_CONFIG+7)
#define REG_SHUTTER4_PRESET1			(REG_SHUTTER_CONFIG+8)
#define REG_SHUTTER1_PRESET2			(REG_SHUTTER_CONFIG+9)
#define REG_SHUTTER2_PRESET2			(REG_SHUTTER_CONFIG+10)
#define REG_SHUTTER3_PRESET2			(REG_SHUTTER_CONFIG+11)
#define REG_SHUTTER4_PRESET2			(REG_SHUTTER_CONFIG+12)
#define REG_SHUTTER1_PRESET3			(REG_SHUTTER_CONFIG+13)
#define REG_SHUTTER2_PRESET3			(REG_SHUTTER_CONFIG+14)
#define REG_SHUTTER3_PRESET3			(REG_SHUTTER_CONFIG+15)
#define REG_SHUTTER4_PRESET3			(REG_SHUTTER_CONFIG+16)
#define REG_SHUTTER1_PRESET4			(REG_SHUTTER_CONFIG+17)
#define REG_SHUTTER2_PRESET4			(REG_SHUTTER_CONFIG+18)
#define REG_SHUTTER3_PRESET4			(REG_SHUTTER_CONFIG+19)
#define REG_SHUTTER4_PRESET4			(REG_SHUTTER_CONFIG+20)
#define PAGE3_END						(REG_SHUTTER_CONFIG+21)


#define REG_ZONE_END					(PAGE3_END)
