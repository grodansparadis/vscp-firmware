...
// Tsjw  --  19.12 Examples of CAN Baud Rate Setting  ---- see datasheet -- ATCAN128.pdf -- pg-266
...
>> propagation delay for 500 m bus
Bus propagation delay = 5 x 10-9 sm-1
Transreceiver delay = 0
500 * 5 ns + 0 = 2500 ns
two side = 2*2500 = 5000 ns   

>> Tscl is programmable and determines the individual bit timing.
Tscl = (BRP[5:0] + 1)/clkIO frequency
     =  (7+1)/16000000
     =  500 ns

>> A prescaler value of 7 gives a CAN system clock of 2MHz and
a Time Quantum of 500ns. This will give 8000 / 500 = 16 time
quanta per bit.

>> PROP_SEG ROUND_UP = 5000ns / 500 = 10
